...
public class ObraController {
    ...
    public ResponseEntity<?> buscarPorGeneros(
            @Parameter(description = "Lista de gêneros para retorno das obras") @RequestParam List<Long> generos) {
    ...
    public ResponseEntity<?> buscarPorMuseus(
            @Parameter(description = "Lista de museus para retorno das obras")  @RequestParam List<Long> museus) {
